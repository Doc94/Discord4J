...
public enum InteractionResponseType {
     ...
     * @deprecated in favor of using {@code discord4j.core.object.component.Button#premium(Snowflake)}. This will continue to function but may eventually be unsupported
     */
    @Deprecated
    PREMIUM_REQUIRED(10);
